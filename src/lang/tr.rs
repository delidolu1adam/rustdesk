...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Masaüstünüze bu Kimlik ve parola ile erişilebilir"),
        ("Password", "Parola"),
        ("Ready", "Hazır"),
        ...
        ("Control Remote Desktop", "Bağlanılacak Uzak Bağlantı Kimliği"),
        ...
        ("terminal-admin-login-tip", "Lütfen kontrol edilen tarafın yönetici kullanıcı adı ve parolanızı giriniz."),
